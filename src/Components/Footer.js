...
const Footer = () => {
    const Tag = ({ children }) => {
        return (
            <span className="px-3 py-1 rounded-lg bg-[#353535] text-xs text-gray-400 uppercase select-none">
                {children}
            </span>
        );
    };
    ...
    const socialMediaButtons = (
        <div className="flex items-center gap-6 font-semibold">
            <a href="." className="text-gray-400 hover:text-white">
                <FontAwesomeIcon className="text-gray-900" icon={faFacebook} />
            </a>
            <a href="." className="text-gray-400 hover:text-white">
                <FontAwesomeIcon className="text-gray-900" icon={faGithub} />
            </a>
        </div>
    );
    ...
    return (
        <footer className="text-gray-900">
            <div className="px-8 lg:px-48 py-12 !bg-[linear-gradient(270deg,#3ae3a6,#2bb2ff)]">
                <div className="flex flex-col md:flex-row gap-8 items-start justify-between">
                    ...
                    <div className="flex flex-col bg-transparent gap-8">
                        <Section label="Tags"  className="bg-transparent" content={SEOTags} />
            ...
            <div className="flex flex-col items-center lg:items-start lg:flex-row justify-between gap-4 px-8 lg:px-48 py-8 bg-[#101010] font-medium text-xs text-gray-600">
                <div>
                    <p>
                        ...
                        <FontAwesomeIcon icon={faHeart} /> by <span className="font-bold">TEAM REVSAFE</span>.
                    </p>
                </div>
                <div>{legalLinks}</div>
            </div>
